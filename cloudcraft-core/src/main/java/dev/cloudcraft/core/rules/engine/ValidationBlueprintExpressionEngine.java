...
public class ValidationBlueprintExpressionEngine implements ExpressionEngine<RuleDefinition.ValidationRuleDefinition, Component, EvaluationResult.ValidationResult> {
    @Override
